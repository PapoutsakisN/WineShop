        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-xl-12 col-md-12 col-xs-12">
                    <h1>Welcome to Wine of Crete</h1>
                </div>
            </div>
            <br>
            <div class="row">
